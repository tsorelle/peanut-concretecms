...
// include Peanut configuration

include_once (DIR_BASE."/tq-peanut/bootstrap/ccms-peanut-app.php");

// additional statements here if needed for further customization
