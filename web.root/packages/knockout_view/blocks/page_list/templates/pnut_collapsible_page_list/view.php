<?php
// code from core version
defined('C5_EXECUTE') or die("Access Denied.");
echo('<!-- Template: pnut_collapsible_page_list');
...
if ($c->isEditMode() && $controller->isBlockEmpty()) {
    ...
    ?>
<!-- end core version code -->
<!-- template: remove pageListTitle and use value for panelTitle -->
<?php
    $panelTitle = (isset($pageListTitle) && $pageListTitle) ? $pageListTitle : 'Pages';
    $pageListTitle = null;
    $collapseState = $c->getAttribute('expand_page_list') === true ? 'in' : 'out';
    $collapseId='page-list-'.uniqid();
?>
    <!-- template: collapsible group header -->
    ...
    <div class="panel panel-default">
        ...
        <?php echo "<div id='$collapseId' class='panel-collapse collapse $collapseState'>"; ?>
        <div class="panel-body">
            <!-- template: collapsible group header end -->


            <!-- code and markup from core version here -->
        ...
        <?php } ?>
            ...
            <!-- end code and markup from core version -->

    <!-- template: collapsible group footer -->
        </div>
            <div class="panel-footer"></div>
        </div>
    </div>
    <!-- template: end collapsible group footer -->
    </div>
    <!-- template: end collapsible panel -->

            <!-- code and markup from core version resumes here -->
